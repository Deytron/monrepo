...
Changement total de plan puisqu'on va passer tous les PC guests en IP DHCP. Pour ça, on utilise la commande ``ip dhcp``.
<!--stackedit_data:
eyJoaXN0b3J5IjpbNDY5Njc4MzYyLDI0Njk4OTM4NCwtMTM3ND
